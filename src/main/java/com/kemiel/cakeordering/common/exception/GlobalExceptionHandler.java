...
public class GlobalExceptionHandler {
    ...
    private HttpStatus resolveHttpStatus(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case PRODUCT_NOT_FOUND, VARIANT_NOT_FOUND, ORDER_NOT_FOUND, CATEGORY_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case INVALID_ORDER_STATUS_TRANSITION, ORDER_CANCEL_NOT_ALLOWED,
                 ...
                 VARIANT_DELETE_NOT_ALLOWED, CONCURRENT_UPDATE_CONFLICT -> HttpStatus.CONFLICT;
